...
- [x] Faza 4.1: Scroll animations (Intersection Observer directive)
- [x] Faza 4.2: Accessibility (skip link, focus-visible, page transitions)
- [x] Faza 4.3: Polish (custom scrollbar, print styles, error page, placeholder pages)
- [x] Statute Page (przepisanie na czysty HTML z sfc-legal layout)
- [x] Menu Header Bottom (nowoczesna szybka nawigacja)
- [x] Page Component (uproszczenie animacji)

### 🔄 Opcjonalne (do rozważenia)

- [ ] Faza 5.1: Dark mode
- [ ] Faza 5.2: Interaktywne elementy (kalkulator BMI, quiz)
- [ ] Gallery Page (gdy będą dostępne zdjęcia)
- [ ] Schedule Page (gdy będzie dostępny harmonogram)
